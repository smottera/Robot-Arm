...
#undef X_STEP_PIN
#define X_STEP_PIN ORIG_E2_STEP_PIN
#undef X_DIR_PIN
#define X_DIR_PIN ORIG_E2_DIR_PIN
#undef X_ENABLE_PIN
#define X_ENABLE_PIN ORIG_E2_ENABLE_PIN
...
#define DECOUPLING_TEST_MAX_HOLD_VARIANCE 65
...
========== Start configuration string ==========
{
    ...
    "psOn": "ORIG_PS_ON_PIN",
    "mixingExtruder": "0",
    "decouplingTestMaxHoldVariance": 65,
